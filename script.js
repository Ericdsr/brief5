...
function checkGuess_hard(){
  var your_guess = Number(guess_box.value);

  if(count_guess <= 2){
      if(your_guess < random_num_hard){
      ...
      else if(your_guess > random_num_hard){
          all_guesses.textContent += your_guess + " ";
          high_or_low.innerHTML += `<div class="card" style="width: 18rem;">
          <div class="card-body">
            <h5 class="card-title">C'est</h5>
...
function checkGuess_medium(){
  var your_guess = Number(guess_box.value);

  if(count_guess <= 2){
      if(your_guess < random_num_medium){
          all_guesses.textContent += your_guess + " ";
          high_or_low.innerHTML += `<div class="card" style="width: 18rem;">
          <div class="card-body">
            <h5 class="card-title">C'est</h5>
      ...
      else if(your_guess > random_num_medium){
          all_guesses.textContent += your_guess + " ";
          high_or_low.innerHTML += `<div class="card" style="width: 18rem;">
          <div class="card-body">
            <h5 class="card-title">C'est</h5>
